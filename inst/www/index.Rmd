---
title: "OpenCPU Scoring Application"
...
can be created to estimate at certain points in the year how many potholes estimated to be filled.
...
```{r plot-model-result, echo=FALSE}
  ...
  suppressWarnings(forecast_plot <- ggplot(data=dat_plotf,aes(x=as.Date(date),y=observed)) +
                    ...
                    ggtitle(paste0('Number of Potholes Filled in Edmonton Canada\n',
...
the model can be viewed at createmodel.R.
...
[(example data)](../../data/testdata.csv).

```{r results='asis', echo=F}
  cat('<form role="form">')
    cat('<div class="form-group">')
      cat('<img src="spinner.gif" class="spinner" style="display:none;" />')
      cat('<input class="btn btn-primary btn-lg" type="file" id="csvfile">') 
      cat('<br>')
